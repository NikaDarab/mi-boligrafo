...
const Signup = (props) => {
  ...
  const handleRegisterOrLogin = (e) => {
      e.preventDefault();
        if (isNewUser) {
            register(createUserWithEmailAndPassword, auth, registerEmail, registerPassword);
        }
  }
      ...
      <div className="max-w-md w-full space-y-8">
        <div>
          ...
          <p className="mt-2 text-center text-sm text-gray-300">
            Or
            <a href="#" className="font-medium text-amber-500 hover:text-green-900" onClick={(e)=> toggleForNewuser(e)}>{"  "}Create an account </a>
          </p>
        </div>
        <form className="mt-8 space-y-6">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="text-sm">
              <a  href="#" className="font-medium text-amber-500 hover:text-green-900" >
          ...
          <div>
            <button
              ...
              onClick={(e)=> { handleRegisterOrLogin(e) }}
            >
              Sign in
            </button>
          </div>
